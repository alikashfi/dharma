...
return [
    ...
    */
    ...
    'present' => ':attribute باید حاظر باشد',
    ...
    'required_with' => 'تکمیل :attribute زمانی که مقدار :values پر شده است الزامی است',
    'required_with_all' => 'تکمیل :attribute زمانی که مقادیر :values پر نشده است الزامی می باشد',
    'required_without' => 'تکمیل :attribute زمانی که مقدار :values پر نشده الزامی است',
    'required_without_all' => 'تکمیل :attribute زمانی که هیچ کدام از مقادیر :values پر نشده الزامی است',
    ...
    */
    ...
    'attributes' => [
        ...
        'current_password' => __('password') . ' فعلی',
        'password' => __('password'),
        'password_confirmation' => 'تکرار ' . __('password'),
        'phone' => 'شماره تلفن',
        'fname' => 'نام',
        'lname' => 'نام خانوادگی',
        'address' => 'آدرس',
        'postal_code' => 'کد پستی',
        'privacy_policy' => 'موافقت با قوانین',
    ],
